...
class Customer {
    // ... (Rest of your Customer class code)
    ...
    void recordTransaction(String description, double amount) {
        Transaction transaction = new Transaction(description, amount);
...
class CustomerManager {
    // ... (Rest of your CustomerManager class code)
    ...
    public void repayLoan(String username, double amount) {
        ...
        if (customer != null) {
            customer.repayLoan(amount);
            customer.recordTransaction(Customer.GREEN + "Loan Repayment" + Customer.RESET, amount);
            saveCustomersToFile();
        }
    }
}
...
class BankApp {
    // ... (Rest of your BankApp class code)
public static final String RESET = "\u001B[0m";
    public static final String YELLOW = "\u001B[33m";
    public static final String RED = "\u001B[31m";
    public static final String GREEN = "\u001B[32m";
