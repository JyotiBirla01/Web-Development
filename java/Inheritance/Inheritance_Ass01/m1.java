    ...
    public static void main(String args[]) {
        ...
        for (int i = 0; i <= 3; i++) {
            if (m1.set() > 2 || m1.invalid() > 0) {
                ...
                Result obj11 = new Result("B.C.A. SEM-1", "DX2006612", 30420104, "BHOLA VISHWKARMA", "SUBHASH",
                        "REGULAR", "R.P.L.MAHESHWARI MAHAVIDYALAYA, INDORE");
                obj.show();
        ...
        for (int i = 0; i <= 3; i++) {
            if (m2.set() > 2 || m2.invalid() > 0) {
                System.out.println("\n\n\t\t\t\tYou have failed, Give the exam again");
                Result obj12 = new Result("B.C.A. SEM-2", "DX2006612", 30420104, "BHOLA VISHWKARMA", "SUBHASH",
                        "REGULAR", "R.P.L.MAHESHWARI MAHAVIDYALAYA, INDORE");
                obj12.show();
        ...
        for (int i = 0; i <= 3; i++) {
            if (m3.set() > 2 || m3.invalid() > 0) {
                System.out.println("\n\n\t\t\t\tYou have failed, Give the exam again");
                Result obj13 = new Result("B.C.A. SEM-3", "DX2006612", 30420104, "BHOLA VISHWKARMA", "SUBHASH",
                        "REGULAR", "R.P.L.MAHESHWARI MAHAVIDYALAYA, INDORE");
                obj13.show();
        ...
        for (int i = 0; i <= 3; i++) {
            if (m4.set() > 2 || m4.invalid() > 0) {
                System.out.println("\n\n\t\t\t\tYou have failed, Give the exam again");
                Result obj14 = new Result("B.C.A. SEM-4", "DX2006612", 30420104, "BHOLA VISHWKARMA", "SUBHASH",
                        "REGULAR", "R.P.L.MAHESHWARI MAHAVIDYALAYA, INDORE");
                obj14.show();
        ...
        for (int i = 0; i <= 3; i++) {
            if (m5.set() > 2 || m5.invalid() > 0) {
                System.out.println("\n\n\t\t\t\tYou have failed, Give the exam again");
                Result obj15 = new Result("B.C.A. SEM-5", "DX2006612", 30420104, "BHOLA VISHWKARMA", "SUBHASH",
                        "REGULAR", "R.P.L.MAHESHWARI MAHAVIDYALAYA, INDORE");
                obj15.show();
        ...
        for (int i = 0; i <= 3; i++) {
            if (m6.set() > 2 || m6.invalid() > 0) {
                System.out.println("\n\n\t\t\t\tYou have failed, Give the exam again");
                Result obj16 = new Result("B.C.A. SEM-6", "DX2006612", 30420104, "BHOLA VISHWKARMA", "SUBHASH",
                        "REGULAR", "R.P.L.MAHESHWARI MAHAVIDYALAYA, INDORE");
                obj16.show();
