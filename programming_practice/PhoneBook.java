...
class PhoneBook {
    ...
    class Personal {
        ...
        public Personal(String name, int phone, String address, String relation) {
            this.relation = relation;

        }

        public void putiniput(String relation) {
            // super.PhoneBook(name, phone, address);
            this.relation = relation;
        }
...
class Main {
    public static void main(String[] args) {
        ...
        String relation1 = sc.nextLine();
        String relation = sc.nextLine();
        PhoneBook obj = new PhoneBook(name, phone, address);
        PhoneBook.Personal obj1 = obj.new Personal(name, phone, address, relation);
        // PhoneBook.Personal.business obj2 = obj.new buisness();
        obj1.getinput();
        PhoneBook.Business obj2 = obj.new Business();
        // PhoneBook.Business.show(); 
