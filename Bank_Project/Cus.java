...
public class Customer implements Serializable {
    ...
    public Customer(String name, String gender, long mobile, long accountNo, String address, int pin, int age, double amt, String ifscCode, String dob, LocalDateTime accountOpen) {
        this.name = name;
        this.gender = gender;
        this.mobile = mobile;
        ...
        try {
            ...
            if (pass.equals("bank123")) {
                try {
                    ...
                    Customer cus = new Customer(name, gender, mobile, accountNo, address, pin, age, amt, ifscCode, dob, accountOpen);
